...
const DEMO_CHEFS: Record<string, ChefViewData> = {
  "marco-esposito": {
    ...
    wall: [
      { name: "Sofia R.",    amount: 25, message: "That carbonara made me cry. Nothing will ever compare.",        time: "2h ago" },
      ...
      { name: "James W.",    amount: 20, message: "Flew to Rome for this. Worth every euro.",                      time: "2d ago" },
      { name: "Chiara M.",   amount: 10, message: "My kids asked to come back before we left the restaurant.",     time: "3d ago" },
    ],
    isDemo: true,
  },
  "dimitri-kostas": {
    ...
    wall: [
      { name: "Andreas K.", amount: 20, message: "Took me straight back to Santorini. Unreal.",                  time: "1h ago" },
      { name: "Maria T.",   amount: 10, message: "The lamb was extraordinary. I dream about it still.",           time: "4h ago" },
      { name: "Table 8",    amount: 35, message: "We already booked next week before the dessert arrived.",       time: "1d ago" },
      { name: "Nikos P.",   amount: 15, message: "Best mezze I have had outside of my yiayia's kitchen.",        time: "2d ago" },
    ],
    isDemo: true,
  },
  "pierre-laurent": {
    ...
    wall: [
      { name: "Amélie D.",  amount: 30, message: "Pierre, vous êtes un génie. This soufflé is immortal.",         time: "3h ago" },
      ...
      { name: "Laurent B.", amount: 40, message: "Michelin stars are not enough. You deserve a constellation.",   time: "3d ago" },
    ],
    isDemo: true,
  },
};
